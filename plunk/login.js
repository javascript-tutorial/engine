...
let readLine = require('lib/readLine');
...
async function login() {
  ...
  let authorizations = githubAuthResponse.body;
  let githubPlunkerAuth = authorizations.find(function(item) {
  ...
  let plunkerAuthResponse = await request.post({
