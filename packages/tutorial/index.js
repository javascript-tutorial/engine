...
const mountHandlerMiddleware = require('@jsengine/koa-utils').mountHandlerMiddleware;

const t = require('@jsengine/i18n');

t.requirePhrase('@jsengine/tutorial', 'article');
t.requirePhrase('@jsengine/tutorial', 'task');
